...
A simple project to act as the landing page for my Raspberry Pi Home Server.
This project was generated using
[Angular CLI](https://github.com/angular/angular-cli) version 21.0.4.
...
`dist/` directory. By default, the production build optimizes your application
